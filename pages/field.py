...
def update_fos_salary_linechart(field_of_study):
    ...
    layout = go.Layout(
        ...
        height = 700,
        title_x = 0.5,
        title='Average Earnings Over Time By Years After Graduation<br>per Job Title Within the Chosen Field (2005-2014)',
...
def update_fos_certification_graph(field_of_study):
    layout = go.Layout(
        ...
        height = 700,
        title_x = 0.5,
        title='Mean Incomes by Certification Type for the Chosen Field (2005-2014)',
